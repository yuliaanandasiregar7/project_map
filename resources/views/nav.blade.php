            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="kabupatenDropdown" style="z-index: 1050;">
                        <a class="dropdown-item" href="/population">Populasi</a>
                        <a class="dropdown-item" href="/sekolah">Jumlah Sekolah</a>
                        <a class="dropdown-item" href="/puskesmas">Jumlah Puskesmas</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="kabupatenDropdown" role="button"
